    ...
    <section id="why" className="border-b border-rule bg-paper">
      <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-12 py-20 sm:py-28">
        <div className="grid grid-cols-12 gap-y-10 lg:gap-x-10">
          ...
          <div className="col-span-12 lg:col-span-7 lg:col-start-6 space-y-6 text-[18px] sm:text-[19px] leading-[1.6] text-ink/85 text-pretty">
            <p className="font-serif text-2xl sm:text-3xl leading-[1.25] text-ink">
            ...
            <div className="pt-8 mt-6 border-t border-rule grid grid-cols-1 sm:grid-cols-2 gap-6">
              <Meta
                eyebrow="Umbrella"
              ...
              <Meta
                ...
                body="Scenes from American media where Cantonese-speaking culture shows up — and belongs."
              />
            </div>
          </div>
        </div>
