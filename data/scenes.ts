...
export const scenes: Scene[] = [
  {
    ...
    cantonesePhrase: "點解你會同 7-11 一齊嘅？",
    romanization: "dim2 gaai2 nei5 wui5 tung4 7-11 jat1 cai4 ge3",
    ...
    body: [
      "Halfway through Rush Hour 2, in a Los Angeles soul-food restaurant, a Black American actor leans over the counter and starts trading Cantonese with Jackie Chan. He points at Chris Tucker, calls him a 7-11, and asks Chan — in Cantonese — why he's running around with the convenience-store guy. Not subtitled-for-laughs Cantonese. Not phonetic Cantonese. Cantonese.",
  ...
  },
  {
    ...
    externalUrl: "https://www.youtube.com/watch?v=FQ_gVYpwI68",
